...
export const HardwareTypeWidget = Vue.component('core-widget-hardwaretype', require('./HardwareTypeWidget.vue'));
export const InstalledMemoryWidget = Vue.component('core-widget-installedmemory', require('./InstalledMemoryWidget.vue'));
export const NewClientsWidget = Vue.component('core-widget-newclients', require('./NewClientsWidget.vue'));
export const UptimeWidget = Vue.component('core-widget-uptime',require('./UptimeWidget.vue'));
